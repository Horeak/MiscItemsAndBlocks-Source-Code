...
public class TileEntityTurtleShellRender extends TileEntitySpecialRenderer {
    
    private final TurtleShellModel model;
   
    public TileEntityTurtleShellRender() {
            this.model = new TurtleShellModel();
    }
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
    	if(te instanceof TileEntityTurtleShell){
    		TileEntityTurtleShell tile = (TileEntityTurtleShell)te;
    	
            GL11.glPushMatrix();
            GL11.glTranslatef((float) x + 0.5F, (float) y + 1.5F, (float) z + 0.5F);
            
            
            bindTexture(new ResourceLocation("miscitems" , "textures/mobs/Turtle.png"));
