package com.miscitems.MiscItemsAndBlocks.Entity;
...
public class EntityPowerArrow extends Entity implements IProjectile
{
	   private int xTile = -1;
	        ...
	        else
	        {
	            ...
	            if (movingobjectposition != null)
	            {
	                if (movingobjectposition.entityHit != null)
	                {
	                    ...
	                    {
	                        damagesource = new DamageSource("powerarrow.shot");
	                    }
	                    else
	                    {
	                        damagesource = new DamageSource("powerarrow.shotby");
	                    }
	    ...
	    public boolean canAttackWithItem(int par1)
	    {
	        return false;
	    }
