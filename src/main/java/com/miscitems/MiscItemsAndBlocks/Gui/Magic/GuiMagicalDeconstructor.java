package com.miscitems.MiscItemsAndBlocks.Gui.Magic;
...
public class GuiMagicalDeconstructor extends GuiContainer {
    ...
    private final ResourceLocation Texture = new ResourceLocation("miscitems", "textures/gui/MagicalDeconstructorGui.png");
