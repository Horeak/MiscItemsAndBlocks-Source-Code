...
import com.miscitems.MiscItemsAndBlocks.Render.ItemRender.*;
...
import com.miscitems.MiscItemsAndBlocks.Render.TileEntityRenderer.*;
...
public class ClientProxy extends ServerProxy {
    ...
    public void registerRenderThings() {
        ...
        if(!Main.config.get("Client Settings", "Disable custom item models?", false).getBoolean(false)){
