...
public class MagicalMaterialUtils {
    ...
    public static void RegisterManualValues(){
        ...
        //Mod values
        RegisterManualValue(new ItemStack(ModItems.IronPlate, 1, 0), 32);
        RegisterManualValue(new ItemStack(ModItems.IronPlate, 1, 1), 32);
        RegisterManualValue(new ItemStack(ModItems.IronPlate, 1, 2), 128);
        RegisterManualValue(ModItems.SilverIngot, 254);
        RegisterManualValue(ModItems.Flour, 25);
